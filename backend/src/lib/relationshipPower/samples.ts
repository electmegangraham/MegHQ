import type { ConversionOpportunity, RelationshipRecord } from "./types.js";

export function getSampleRelationships(): RelationshipRecord[] {
  return [
    {
...
export function getSampleOpportunities(): ConversionOpportunity[] {
  return [
    {
