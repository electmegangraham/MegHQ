import type { StaffQueueItem, StaffViewResponse, StaffViewType } from "./types.js";

function sortItems(items: StaffQueueItem[]): StaffQueueItem[] {
...
export function buildStaffView(view: StaffViewType, items: StaffQueueItem[]): StaffViewResponse {
  return {
    view,
