import type { WebsiteElementCandidate, WebsiteRule } from "./types.js";

export function getSampleWebsiteRules(): WebsiteRule[] {
  return [
    {
...
export function getSampleWebsiteCandidates(): WebsiteElementCandidate[] {
  return [
